...
2. ## 初めての React App , React Component
...
5. ## Ajax, XMLHttpRequest で外部 API を叩いてデータを取得するアプリの作成
...
7. ## create-react-app を使ったローカル開発環境の作成
...
8. ## [giphy](https://giphy.com/) を使った画像検索アプリ
...
12. ## Giphy アプリを Redux, Redux-router, Redux-thunk, Aiox で作る
